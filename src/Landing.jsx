...
const Landing = () => {
  ...
  return (
    <div className="relative min-h-screen bg-white selection:bg-blue-100">
      ...
      <div className="relative pt-32 pb-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-40">
          ...
          >
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-100 text-blue-600 text-sm font-bold mb-10"
            >
              <Star size={14} className="fill-blue-500" /> 
              <span>MHT-CET Predictor 2024-25</span>
            </motion.div>

            <motion.h1 variants={itemVariants} className="text-6xl md:text-8xl font-black text-slate-900 tracking-tight mb-10 leading-[0.9]">
              Find Your <br />
              <span className="text-blue-600 underline decoration-blue-200 underline-offset-8">Perfect Fit.</span>
            </motion.h1>

            <motion.p variants={itemVariants} className="text-xl md:text-2xl text-blue-600/80 max-w-xl mb-14 font-medium leading-relaxed">
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-6 items-center">
              <Link to="/predictor" className="group bg-blue-600 hover:bg-blue-700 text-white font-black py-6 px-14 rounded-[2.5rem] text-2xl flex items-center justify-center gap-3 transition-all shadow-2xl shadow-blue-500/30 active:scale-95">
          ...
          >
            ...
            <div className="relative rounded-[3rem] overflow-hidden border-[12px] border-white shadow-2xl rotate-3 hover:rotate-0 transition-all duration-700">
              <img src="/assets/student.png" alt="Engineering Student" className="w-full h-full object-cover" />
              <div className="absolute bottom-8 left-8 right-8 glass p-6 bg-white/40 backdrop-blur-md rounded-2xl border border-white/40 shadow-xl">
        ...
        <div className="mb-40">
          ...
          >
            <h2 className="text-5xl font-black text-slate-900 mb-6 tracking-tight">Iconic Engineering Colleges</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              ...
              <motion.div 
                key={i}
                whileHover={{ y: -15 }}
                className="group relative rounded-[3rem] overflow-hidden shadow-2xl bg-white border border-slate-100 flex flex-col"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-40">
          <motion.div 
            ...
            className="md:col-span-8 p-16 bg-slate-50 rounded-[4rem] border border-slate-100 flex flex-col justify-between"
          >
          ...
          <motion.div 
            whileHover={{ scale: 1.01 }}
            className="md:col-span-4 p-16 bg-blue-600 rounded-[4rem] text-white flex flex-col justify-between shadow-2xl shadow-blue-600/30"
          >
        ...
        {/* Footer */}
        <footer className="pt-24 border-t border-slate-100 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-slate-400 text-xs font-bold uppercase tracking-widest items-center">
            <div className="text-left">Trusted by students worldwide.</div>
            <div className="flex justify-center gap-10">
              <a href="#" className="hover:text-blue-600 transition-colors">Privacy</a>
              <a href="#" className="hover:text-blue-600 transition-colors">Terms</a>
            </div>
            <div className="text-right">&copy; 2024 CET PREDICTOR</div>
          </div>
        </footer>
      </div>
    </div>
